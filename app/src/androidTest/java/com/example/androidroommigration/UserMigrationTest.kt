...
class UserMigrationTest {
    ...
    val helper = MigrationTestHelper(
        ...
        listOf(UserDatabase.Migration2To3()), // only custom migration here
    ...
    fun migration1To2_containsCorrectData() {
        ...
        db.query("SELECT * FROM user").apply {
            assertThat(moveToFirst()).isTrue() // there is an entry after migration
            assertThat(getLong(getColumnIndex("created"))).isEqualTo(0) // the entry have the new field and his value is 0
        }
    }
